...
# Media pipe Initialization pose_class - pose_image - Pose_Video && Drawing Utilities...
...
def detectPose(image, pose, draw=False, display=False):
    ...
    # landmarks Detection & Drawing On Output Image...
    ...
    # Checking the original input image and the resultant image are specified to be displayed.
    if display:
...
def checkHandsJoined(image, results, draw=False, display=False):
    ...
    # Hands Joined status & Hands Distance On Output Screen.
    if draw:
...
# Checking Horizontal Position Left, Right or Center...
        ...
        if checkHandsJoined(frame, results)[1] == 'Hands Joined':
            ...
            if counter == num_of_frames:
                ...
                if not (game_started):
                    ...
                    # Y-coordinate of the mid-point of both shoulders
...
# Video capture Release Window Closed
